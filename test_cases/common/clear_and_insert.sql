...
INSERT INTO slg.mst_group_common (profile_name,group_id,group_name,group_type,group_desc,is_active,group_seq,is_disable,default_value) VALUES
	 ...
	 ('Prepaid','7c9e0eea-c3de-49cd-a6c2-31802a3e6d23','Subscriber Status','multi_dropdown','Subscriber Status',true,1,true,NULL),
	 ('Prepaid','438b3e0a-a0b6-4938-b8e0-e1a1957bfd20','Customer Grade','text','TEST TEXT BOX',false,7,false,NULL),
	 ('Prepaid','38ac0ac1-d88d-40fb-bcff-8d8c7c3daf12','Subscriber Type','radio','Subscriber Type',true,2,false,''),
	 ('Postpaid','7c9e0eea-c3de-49cd-a6c2-318222222222','Subscriber Status 12','checkbox','Subscriber Status 12',true,1,false,''),
	 ('Prepaid','b5d40207-dd9f-4dab-8b8c-82f08f0f4e70','Thai  ID Card','dropdown','Thai  ID Card',true,4,false,''),
	 ('Prepaid','87cdb94a-5d6b-4d6c-81e8-6718241e96f1','Turecard Type','listbox','Turecard Type',true,6,false,'Green'),
	 ('Prepaid','1bd3cda0-f8d5-45ee-a260-bc4563a6f5f1','TEST COMMON DELETE 1','dropdown','TEST COMMON DELETE 1 DESCRIPTION',true,20,false,'SOCIAL'),
	 ('Prepaid','d13d270d-114b-4f35-880c-fdb0981ca1bd','TEST COMMON DELETE 2','checkbox','TEST COMMON DELETE 2 DESCRIPTION',true,21,false,'Sub Dealer');
